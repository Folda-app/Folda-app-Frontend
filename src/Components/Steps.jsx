...
function Steps(props) { 
    const Note = 'Fast track your investments progress, get started with us'
    return (
            ...
            <div className=' py-10 w-full bg-blue-50 lg:rounded-2xl justify-center items-center gap-8 inline-flex'>
                <div className=' px-12 md:px-8 lg:px-14 flex self-stretch flex-col md:flex-row justify-center items-center  gap-4 md:gap-0 lg:gap-16 '>
                    <div className=' flex-col justify-start items-start gap-6 inline-flex '>
                        ...
                        <p className='text-emerald-950 lg:text-4xl md:text-3xl text-xl font-extrabold md:w-80 lg:w-96'>Get started in quick and easy steps</p>
                        <p className='text-gray-500 text-sm leading-tight lg:text-xl md:text-lg font-normal md:leading-relaxed lg:leading-9  md:w-80 lg:w-96'>Fast track your investments progress, get started with us</p>
                        </div>
                    ...
                    <div className='grid gap-3 grid-cols-1 md:grid-cols-2  '>
                        <StepItem Icon={homeIcon} Title='Create Account' Note={Note}/>
                        <StepItem Icon={Wallet} Title='Fund Wallet' Note={Note}/>
                        <StepItem Icon={rocket} Title='Invest' Note={Note}/>
                        <StepItem Icon={trendUp} Title='Earn' Note={Note}/>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div className='px-4 py-12 md:px-20 lg:px-44 md:py-16 lg:py-36 bg-white justify-center items-center flex '>
            <div className='grow shrink basis-0 self-stretch justify-between items-center flex gap-14 flex-col md:flex-row'>
                <div className='flex-col justify-start items-start gap-3 md:gap-6 lg:gap-8 flex md:w-1/2'>
                    <p className='text-emerald-950 text-xl lg:text-4xl font-extrabold font-Gilroy'>Our growth over the years</p>
                    <p className='text-gray-500 lg:text-xl font-normal leading-tight lg:leading-9 font-Lato'>Folda provides an avenue to own a fraction of home or commercial assets instead of the entire property.</p>
                </div>
                <div className='grid grid-cols-2  gap-4 md:w-1/2'>
                    {BenchMark.map((mark) => (
                        ...
                        <div className=" self-stretch flex-col justify-start items-center gap-2 md:gap-4 inline-flex">
                          <p className="text-cyan-500 text-2xl lg:text-4xl font-extrabold font-Gilroy">{mark.number}</p>
                          <p className=" text-gray-500 text-center text-xs lg:text-sm font-normal lg:leading-relaxed font-Lato">{mark.variable}</p>
                        </div>
                      </div>
                    ))}
                </div>

            ...
            <div className='flex items-center justify-center px-4 py-12 md:px-20 lg:px-36 md:py-16  '>
                <div className='flex flex-col-reverse md:flex-row items-center justify-between gap-5 md:gap-10 lg:gap-20'>
                    ...
                    <div className='flex-col justify-start items-start gap-4 md:gap-8 flex w-full md:w-1/2'>
                        <h1 className='self-stretch text-emerald-950 text-xl md:text-3xl lg:text-4xl font-extrabold'>Grow with peers of common goals</h1>
                        <p className='self-stretch text-gray-500 text-sm md:text-lg lg:text-xl font-normal leading-tight md:leading-9'>Folda is a proptech company offering private and fractional real estate equity investment to africans globally. Folda provides an avenue to own a fraction fo home or commercial assets instead of the entire property.</p>
                    </div>
                </div>
            </div>
            {/* Details 2 */}

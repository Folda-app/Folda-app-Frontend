        ...
        <div className='bg-blue-50 justify-center items-center flex px-5 pt-11 pb-20 md:px-20 md:py-8 lg:px-44 lg:py-16'>
            <div className='self-stretch flex-col justify-start items-start gap-12 flex'>
                <div className="flex-col justify-start items-start gap-3 flex w-full">
                    <div className=" text-emerald-950 text-xl md:text-3xl lg:text-4xl font-extrabold font-Gilroy">Our Goal</div>
                    <div className=" text-gray-500 text-sm md:text-md lg:text-xl font-normal leading-tight md:leading-relaxed lg:leading-9 font-Lato">Our values proceeds us</div>
                </div>
                    ...
                    {Items.map((item) => (
                        ...
                        <div className="self-stretch flex-col justify-start items-start gap-4 flex">
                          ...
                          <div className="w-full self-stretch  flex-col justify-start items-start gap-1.5 md:gap-3 flex">
                            <div className="self-stretch text-cyan-500 text-lg md:text-md lg:text-xl font-extrabold font-Gilroy ">Growth</div>
                            <div className="self-stretch text-gray-500 text-sm md:text-xs lg:text-md font-medium leading-snug lg:leading-relaxed font-Lato">We are focused on providing quality assets for investments. Folda is a proptech company offering private and fractional real estate equity investment to africans globally. </div>
                          </div>
                        </div>
                      </div>
                    ))}

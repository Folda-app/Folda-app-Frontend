        ...
        <div className='px-4 md:px-6 lg:px-20 py-10 justify-center items-center bg-white'>
            <div className='flex md:flex-row flex-col justify-between items-center gap-10'>
                <div className='flex flex-col md:w-1/2 justify-start items-start gap-8 lg:gap-10'>
                    ...
                    <h1 className='text-emerald-950 text-2xl md:text-3xl lg:text-4xl font-extrabold font-Gilroy'>Growth is easy with a community</h1>
                    <h5 className='text-gray-500 text-sm md:text-lg lg:text-xl font-normal leading-tight lg:leading-9 font-Lato'>Meet peers with similar goals and upscale your investment journey</h5>
                    </div>
